package bsu.rfe.java.group6.Suzdalev.lab4.var1.a;
...
public class GraphicsDisplay extends JPanel {
	...
	public GraphicsDisplay() {
		...
		graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT,
				BasicStroke.JOIN_ROUND, 10.0f, new float[] {24, 6, 6, 6, 6, 6, 12, 6, 12}, 0.0f);
	...
	protected void paintMarkers(Graphics2D canvas) {
		...
		for (Double[] point: graphicsData) {
			...
			canvas.draw(new Line2D.Double(shiftPoint(center, -3, 5), shiftPoint(center, 3, 5)));
			canvas.draw(new Line2D.Double(shiftPoint(center, -3, -5), shiftPoint(center, 3, -5)));
			canvas.draw(new Line2D.Double(shiftPoint(center, 5, -3), shiftPoint(center, 5, 3)));
			canvas.draw(new Line2D.Double(shiftPoint(center, -5, -3), shiftPoint(center, -5, 3)));
		}
	}
